...
import { algogatherImg, algogatherImg2, bidrumImg, bidrumImg2, cauCalendarImg, caumdIdImg, caumdImg, caumdImg2, cauPreTimetableImg, cauRssImg, goinmulTestImg, goinmulTestImg2, namufixImg, sketchDailyImg, sketchDailyImg2 } from './assets';
...
const projectData: ProjectData[] = [
    {
        ...
        description: <>
            바이드럼은 장구 형태의 장치를 이용하는 아케이드 리듬게임으로, Rust 언어와 SDL2 프레임워크를 이용하여 개발됐습니다.<br />
            <ul>
                <li>X Window System이 설치된 Linux 시스템에서 동작하며, Mac OS에서도 정상적으로 작동합니다.</li>
                <li>실제 장구를 이용한 하드웨어 컨트롤러 및 동전인식기/지폐인식기와 연결할 수 있습니다.</li>
                <li>타격시 타격 장치와 타격된 부위를 인식하며<span className={printHidden}>(<a href="#bidrum-patent">관련 특허 출원</a>)</span>&nbsp;
                    이를 이용한 총 4가지 종류의 노트가 있습니다.</li>
            </ul>
        </>,
        important: true
    },
    {
        ...
        description: <>
            고인물테스트는 <a href="http://www.shuru.co.kr/">주식회사 슈르</a>의 비영리 퀴즈 웹사이트로,&nbsp;
            Typescript를 이용하여 프론트엔드 개발에 참여했습니다.
        </>,
        important: true
    },
    {
        ...
        description: <>
            알고리즘 스터디를 더 편리하게 할 수 있도록 하기 위해 만들어진 프로젝트로, 저는 프론트엔드를 담당하였으며 React를 이용했습니다.<br />
            이 프로젝트는 다음과 같은 기능을 제공하며, 현재 개발중입니다.
            <ul>
    ...
    },
    {
        ...
        description: <>
            군대에서 <a href="http://reference.sketchdaily.net/">SketchDaily references</a> 사이트를 이용해서 그림 연습을 했는데, 핸드폰에서 웹사이트 이용하기가 은근히 불편해서 직접 만든 어플리케이션입니다.<br />
    ...
    },
    {
        ...
        description: <>
            ...
            <br />
            초기에는 저가 VPS 위에 Docker를 이용하는 방식으로 배포하였으며, 현재는 AWS S3와 AWS Lambda를 이용하는 식으로 배포했습니다.
            <br />
    ...
    },
    {
        ...
        description: <>
            중앙대학교의 각종 공지사항을 RSS나 Atom 피드 형태로 제공하여 실시간 구독할 수 있도록 해주는 서비스입니다.<br />
    ...
    },
    {
        ...
        description: <>
            중앙대학교 학사일정을 구글 캘린더나 아웃룩 등에서 구독할 수 있도록 iCalendar 형태로 제공하는 서비스입니다.<br />
    ...
    },
    {
        ...
        description: <>
            나무위키의 편집과 관리를 편하게 해주는 웹 브라우저 확장 스크립트입니다.<br />
            ...
            <ul>
                ...
                <li>토론 UI에 아이덴티콘을 추가하고 토론에서의 인용을 쉽게 볼 수 있게 하는 등 토론을 편리하게 해주는 기능 추가</li>
            </ul>
        </>,
        important: true
    }
