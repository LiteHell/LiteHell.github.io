    ...
    return (
        <article className={styles.portfolio}>
            ...
            <section>
                <h2>자기소개</h2>
                <p>
                    안녕하세요! 소프트웨어 개발을 좋아하고, 평소 리눅스를 이용하는 신연진입니다.<br />
                    웹, 게임, 응용 소프트웨어 등 다양한 영역에서의 개발을 즐깁니다.
                </p>
                <p className={printOnly}>
                    지금 보고 계신 이 포토폴리오는 <a href="https://yeonjin.name/portfolio">https://yeonjin.name/portfolio</a>에서도 보실 수 있습니다!
                </p>
            </section>
            <section>
                <h2>경력 및 인턴십</h2>
                <Timeline>
                    <CVTimelineItem startedAt={new Date(2024, 6, 1)} title="주식회사 슈르" inProgress>
                        소프트웨어 개발자
                        <ul>
                            <li>2024년 6월에 입사하여, React와 Firebase를 이용해 <a href="https://shumaru.shop">슈마루</a>의 백오피스를 개발함</li>
            ...
            <section>
                <h2>학력</h2>
                <Timeline>
                    <CVTimelineItem startedAt={new Date(2019, 3, 1)} endedAt={new Date(2024, 8, 1)} title="중앙대학교 소프트웨어학부">
                        학점: 4.23/4.5
                        <ul>
            ...
            <section className={pageBreak}>
                <h2>특허 출원</h2>
                <Timeline>
                    <CVTimelineItem startedAt={new Date(2024, 3, 1)} title="리듬 게임 장치 및 이의 동작 방법" anchor="bidrum-patent" inProgress={false}>
                        <p>
            ...
            <section>
                <h2>교내 활동</h2>
                <Timeline>
                    <CVTimelineItem startedAt={new Date(2023, 1, 1)} endedAt={new Date(2023, 12, 1)}
                        title="동아리연합회 문화창작분과장"
                    >
                        경선에서 당선되고 다음과 같은 활동을 했습니다.
                        <ul>
                            <li><a href="https://cauclub.co.kr/rules/?idx=16891750&bmode=view">회의록 공개에 관한 자치령</a> 제정을 통한 회의록 공개 의무화</li>
                            <li>합동전시회 "잇닿음제" 주최</li>
                        </ul>
                    </CVTimelineItem>
                    <CVTimelineItem startedAt={new Date(2023, 1, 1)} endedAt={new Date(2023, 12, 1)}
                    ...
                    >
                        소프트웨어학부 알고리즘 학회 <a href="https://cauchaos.github.io">ChAOS</a>의 부회장직을 역임하며 다음과 같은 활동을 했습니다.<br />
                        <ul>
                            <li>알고리즘 문제풀이 스터디 활동 운영</li>
                            <li>알고리즘 경진대회 스태프 참여</li>
                        </ul>
                    </CVTimelineItem>
                    <CVTimelineItem startedAt={new Date(2020, 1, 1)} endedAt={new Date(2020, 12, 1)}
                        title="만화두레 부회장"
                    >
                        중앙동아리 만화두레의 부회장을 역임하며 다음과 같은 활동을 했습니다.<br />
                        <ul>
