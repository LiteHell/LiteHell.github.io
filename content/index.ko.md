...
### Projects and Contributions
 ...
 - <small>2020</small> [만화두레](https://caumd.club/) : 부회장으로 재임하는 동안 여러 웹사이트를 개발하고 유지보수했습니다.
    ...
    - [회원관리 사이트](https://id.caumd.club) ([GitHub](https://github.com/manhwadurae/manduid)) <span class="tag">Typescript</span> <span class="tag">Node.js</span> : 회원관리 기능과 통합 로그인 기능을 제공하는 웹 어플리케이션입니다. 통합 로그인을 위해 OpenID Connect 1.0 표준을 구현했습니다.
